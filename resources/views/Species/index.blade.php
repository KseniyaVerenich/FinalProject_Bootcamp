...
<div class='container'>
  ...
  <div class='row'>
    ...
    <div class="col-7">
      <a href="/species/{{$item->id}}/care" style="color: #fffdef; text-decoration: none;">
       <br>
        <h4>{{$item->common}}</h4>
    ...
    <div class="col">
      ...
      <a href="/species/{{$item->id}}" style="color: #fffdef; text-decoration: none;"><svg id="i-plus" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
